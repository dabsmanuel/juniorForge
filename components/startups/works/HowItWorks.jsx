      ...
      <div className='max-w-6xl mx-auto lg:px-6 px-4 leading-tight py-32 lg:mt-0 mt-12 lg:block hidden'>
        ...
        <div className='flex lg:flex-row flex-col lg:space-y-0 space-y-8 justify-between mt-6'>
          <div className=''>
            ...
            <ul>
              <li className='lg:text-2xl font-bold lg:text-start text-center list-disc list-inside'>Post your role as a startup</li>
            </ul>
          </div>
          <div>
            <h2 className='lg:text-[48px] text-[32px] font-bold text-center'>3</h2>
            <ul>
              <li className='lg:text-2xl font-bold lg:text-start text-center list-disc list-inside'>Interview + Start</li>
            </ul>
          </div>
        </div>
        <div className='text-center mt-6'>
          ...
          <ul>
            <li className='lg:text-2xl font-bold list-disc list-inside'>Get Matched Fast</li>
          </ul>
        </div>
      </div>
      ...
      <div className='max-w-6xl mx-auto lg:px-6 px-4 leading-tight py-32 lg:mt-0 mt-12 lg:hidden block'>
        ...
        <div className='flex lg:flex-row flex-col lg:space-y-0 space-y-8 justify-between mt-6'>
          ...
          <div className=''>
            ...
            <ul>
              <li className='lg:text-2xl font-bold lg:text-start text-center list-disc list-inside'>Get Matched Fast</li>
            </ul>
          </div>
          <div>
