      ...
      >
        ...
        <div className='flex lg:flex-row flex-col lg:space-y-0 space-y-8 justify-between mt-6'>
          ...
          >
            ...
            <ul>
              <li className='lg:text-2xl font-bold lg:text-start text-center list-disc list-inside'>
                Post your role as a startup
              </li>
            </ul>
          </motion.div>
        ...
        >
          ...
          <ul>
            <li className='lg:text-2xl font-bold list-disc list-inside'>
              Get Matched Fast
            </li>
          </ul>
        </motion.div>
